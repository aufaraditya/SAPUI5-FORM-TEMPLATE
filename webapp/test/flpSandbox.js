		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "JSON Source Sample Project",
									"targetURL": "#aaufarfiorijsonsampleproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"aaufarfiorijsonsampleproject-display": {
								"semanticObject": "aaufarfiorijsonsampleproject",
								"action": "display",
								"description": "A Fiori application with JSON Data as Source",
								"title": "JSON Source Sample Project",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=aaufar.fiorijsonsampleproject",
									"url": sap.ui.require.toUrl("aaufar/fiorijsonsampleproject")
								}
							}
						}
					}
